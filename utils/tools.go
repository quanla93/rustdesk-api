...
// Keys is a generic function where K is the key type and V is the value type
...
// Values is a generic function where K is the key type and V is the value type
