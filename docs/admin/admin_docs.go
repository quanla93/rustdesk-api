    ...
    "paths": {
        ...
        "/admin/address_book/list": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Whether it belongs to me",
                        "name": "is_my",
                        "in": "query"
                    }
                ],
        ...
        "/admin/address_book_collection/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Address book collectionInformation",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/address_book_collection/delete": {
            "post": {
                ...
                "description": "Address book collectionDelete",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Address book collectionDelete",
                "parameters": [
                    {
                        "description": "Address book collectionInformation",
                        "name": "body",
        ...
        "/admin/address_book_collection/detail/{id}": {
            "get": {
                ...
                "description": "Address book collectionDetails",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Address book collectionDetails",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID",
        ...
        "/admin/address_book_collection/list": {
            "get": {
                ...
                "description": "Address book collectionList",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Address book collectionList",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Page number",
        ...
        "/admin/address_book_collection/update": {
            "post": {
                ...
                "description": "Address book collectionEdit",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Address book collectionEdit",
                "parameters": [
                    {
                        "description": "Address book collectionInformation",
                        "name": "body",
        ...
        "/admin/audit_conn/batchDelete": {
            "post": {
                ...
                "description": "Connection logBatchDelete",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Connection logBatchDelete",
                "parameters": [
                    {
        ...
        "/admin/audit_file/batchDelete": {
            "post": {
                ...
                "description": "File logBatchDelete",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/admin/device_group/create": {
            "post": {
                ...
                "description": "CreateDevice group",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "CreateDevice group",
                "parameters": [
                    {
                        "description": "Device groupInformation",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/device_group/delete": {
            "post": {
                ...
                "description": "Device groupDelete",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/admin/device_group/detail/{id}": {
            "get": {
                ...
                "description": "Device groupDetails",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/admin/login_log/batchDelete": {
            "post": {
                ...
                "description": "Login logBatchDelete",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/admin/my/share_record/batchDelete": {
            "post": {
                ...
                "description": "BatchDeleteMyShare record",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "BatchDeleteMyShare record",
                "parameters": [
                    {
                        "description": "id",
                        "name": "body",
        ...
        "/admin/user/changeCurPwd": {
            "post": {
                ...
                "description": "ChangeCurrent userPassword",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "ChangeCurrent userPassword",
                "parameters": [
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.User passwordForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/user_token/batchDelete": {
            "post": {
                ...
                "description": "Login credentialsBatchDelete",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Login credentialsBatchDelete",
                "parameters": [
                    {
                        "description": "Login credentialsInformation",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/user_token/delete": {
            "post": {
                ...
                "description": "Login credentialsDelete",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Login credentialsDelete",
                "parameters": [
                    {
                        "description": "Login credentialsInformation",
                        "name": "body",
        ...
        "/admin/user_token/list": {
            "get": {
                ...
                "description": "Login credentialsList",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "admin.UserForm": {
            ...
            "properties": {
                ...
                "email": {
                    "description": "validate:\"required,email\" email is not required",
                    "type": "string"
                },
                "group_id": {
                    "type": "integer"
        ...
        "model.StatusCode": {
            ...
            "x-enum-comments": {
                "COMMON_STATUS_DISABLED": "common status disabled",
                "COMMON_STATUS_ENABLE": "common status enabled"
            },
            "x-enum-varnames": [
